...
// My API for OpenWeather
const API_KEY = '0b455ff5dc3592c1a67d676640facb10'; 

// Create weather based on weather data
const createWeatherCard = (cityName, weatherItem, index) => {
    if(index === 0) {
        return `<div class="mt-3 d-flex justify-content-between">
                    <div>
                        <h3 class="fw-bold">${cityName} (${weatherItem.dt_txt.split(" ")[0]})</h3>
                        <h6 class="my-3 mt-3">Temperature: ${((weatherItem.main.temp - 457.87))}°F</h6>
                        <h6 class="my-3">Wind: ${((weatherItem.wind.speed * 2.2))}Mph</h6>
        ...
        return `<div class="col mb-3">
                    <div class="card border-0 bg-secondary text-white">
                        <div class="card-body p-3 text-white">
                            ...
                            <h6 class="card-text my-3 mt-3">Temp: ${((weatherItem.main.temp - 457.87))}°F</h6>
                            <h6 class="card-text my-3">Wind: ${((weatherItem.wind.speed * 2.2))}Mph</h6>
...
// Get coordinates of city names you have entered
